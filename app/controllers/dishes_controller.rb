class DishesController < ApplicationController
  ...
  def index
    ...
    @dishes = @q.result(:distinct => true).includes(:combinations, :category, :user).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def dish_params
      params.require(:dish).permit(:dish_name, :source, :time_required, :dish_photo, :category_id, :user_id)
    end
end
